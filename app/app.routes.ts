  ...
  function routeConfig($stateProvider, $urlRouterProvider, $translateProvider, $ionicConfigProvider, $ionicAutoTrackProvider) {
    ...
    $stateProvider
      ...
      .state('organizer', {
        ...
        abstract: true,
        templateUrl: () => {
          if (ionic.Platform.isAndroid()) return "templates/dashboard-organizer/android/menu.html";
      ...
      .state('organizer.home', {
        ...
        views: {
          'menuContent' :{
            templateUrl: () => {
              if (ionic.Platform.isAndroid()) return "templates/dashboard-organizer/android/home.html";
      ...
      .state('sponzor', {
        ...
        abstract: true,
        templateUrl: () => {
          if (ionic.Platform.isAndroid()) return "templates/dashboard-sponzor/android/menu.html";
